...
import { TextoComponent } from './layout/components/texto/texto.component';
...
const routes: Routes = [
  ...
  { path: 'buscador/:tipo/:txt', component: BuscadorComponent },
  { path: 'buscador/:tipo/:txt/:page', component: BuscadorComponent },
